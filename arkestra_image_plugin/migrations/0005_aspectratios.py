...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FilerImage.aspect_ratio'
        db.add_column('cmsplugin_filerimage', 'aspect_ratio', orm['cmsplugin_filer_image.filerimage:aspect_ratio'])
        
        # Deleting field 'FilerImage.free_link'
        db.delete_column('cmsplugin_filerimage', 'free_link')
        
        # Deleting field 'FilerImage.page_link'
        db.delete_column('cmsplugin_filerimage', 'page_link_id')
        
        # Changing field 'FilerImage.width'
        # (to signature: django.db.models.fields.FloatField(null=True, blank=True))
        db.alter_column('cmsplugin_filerimage', 'width', orm['cmsplugin_filer_image.filerimage:width'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'FilerImage.aspect_ratio'
        db.delete_column('cmsplugin_filerimage', 'aspect_ratio')
        
        # Adding field 'FilerImage.free_link'
        db.add_column('cmsplugin_filerimage', 'free_link', orm['cmsplugin_filer_image.filerimage:free_link'])
        
        # Adding field 'FilerImage.page_link'
        db.add_column('cmsplugin_filerimage', 'page_link', orm['cmsplugin_filer_image.filerimage:page_link'])
    ...
    models = {
        ...
        'cmsplugin_filer_image.filerimage': {
            ...
            'width': ('django.db.models.fields.FloatField', [], {'default': '1.5', 'null': 'True', 'blank': 'True'})
        },
