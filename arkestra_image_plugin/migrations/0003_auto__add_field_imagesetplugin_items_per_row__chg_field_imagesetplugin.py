...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageSetPlugin.items_per_row'
        db.add_column('cmsplugin_imagesetplugin', 'items_per_row', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True), keep_default=False)

        # Changing field 'ImageSetPlugin.width'
        db.alter_column('cmsplugin_imagesetplugin', 'width', self.gf('django.db.models.fields.FloatField')())

        # Adding field 'ImageSetItem.destination_content_type'
        db.add_column('arkestra_image_plugin_imagesetitem', 'destination_content_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='links_to_imagesetitem', null=True, to=orm['contenttypes.ContentType']), keep_default=False)

        # Adding field 'ImageSetItem.destination_object_id'
        db.add_column('arkestra_image_plugin_imagesetitem', 'destination_object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ImageSetPlugin.items_per_row'
        db.delete_column('cmsplugin_imagesetplugin', 'items_per_row')

        # Changing field 'ImageSetPlugin.width'
        db.alter_column('cmsplugin_imagesetplugin', 'width', self.gf('django.db.models.fields.FloatField')(null=True))

        # Deleting field 'ImageSetItem.destination_content_type'
        db.delete_column('arkestra_image_plugin_imagesetitem', 'destination_content_type_id')

        # Deleting field 'ImageSetItem.destination_object_id'
        db.delete_column('arkestra_image_plugin_imagesetitem', 'destination_object_id')
