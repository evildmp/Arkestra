...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FilerVideoEditor.video'
        db.alter_column('cmsplugin_filervideoeditor', 'video_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Video']))


    def backwards(self, orm):
        
        # Changing field 'FilerVideoEditor.video'
        db.alter_column('cmsplugin_filervideoeditor', 'video_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File']))
