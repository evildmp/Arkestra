...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entity.news_page_intro'
        db.add_column('contacts_and_people_entity', 'news_page_intro', self.gf('django.db.models.fields.related.ForeignKey')(related_name='news_page_intro', null=True, to=orm['cms.Placeholder']), keep_default=False)

        # Adding field 'Entity.contacts_page_intro'
        db.add_column('contacts_and_people_entity', 'contacts_page_intro', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contacts_page_intro', null=True, to=orm['cms.Placeholder']), keep_default=False)

        # Adding field 'Entity.vacancies_page_intro'
        db.add_column('contacts_and_people_entity', 'vacancies_page_intro', self.gf('django.db.models.fields.related.ForeignKey')(related_name='vacancies_page_intro', null=True, to=orm['cms.Placeholder']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entity.news_page_intro'
        db.delete_column('contacts_and_people_entity', 'news_page_intro_id')

        # Deleting field 'Entity.contacts_page_intro'
        db.delete_column('contacts_and_people_entity', 'contacts_page_intro_id')

        # Deleting field 'Entity.vacancies_page_intro'
        db.delete_column('contacts_and_people_entity', 'vacancies_page_intro_id')
