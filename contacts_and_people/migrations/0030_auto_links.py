...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EntityAutoPageLinkPluginEditor.text_override'
        db.add_column('cmsplugin_entityautopagelinkplugineditor', 'text_override', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EntityAutoPageLinkPluginEditor.text_override'
        db.delete_column('cmsplugin_entityautopagelinkplugineditor', 'text_override')
