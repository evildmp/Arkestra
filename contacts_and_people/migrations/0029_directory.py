...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EntityDirectoryPluginEditor.use_short_names'
        db.add_column('cmsplugin_entitydirectoryplugineditor', 'use_short_names', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EntityDirectoryPluginEditor.use_short_names'
        db.delete_column('cmsplugin_entitydirectoryplugineditor', 'use_short_names')
