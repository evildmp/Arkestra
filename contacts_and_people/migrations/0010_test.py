...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('contacts_and_people_entity', 'publications_page_menu_title', orm['contacts_and_people.entity:publications_page_menu_title'])
        
        # Adding field 'Entity.auto_publications_page'
        db.add_column('contacts_and_people_entity', 'auto_publications_page', orm['contacts_and_people.entity:auto_publications_page'])
