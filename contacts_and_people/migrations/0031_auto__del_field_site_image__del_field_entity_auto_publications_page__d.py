...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Building.image'
        db.delete_column('contacts_and_people_building', 'image_id')

        # Adding field 'Building.getting_here'
        db.add_column('contacts_and_people_building', 'getting_here', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Building.access_and_parking'
        db.add_column('contacts_and_people_building', 'access_and_parking', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Building.image'
        db.add_column('contacts_and_people_building', 'image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['image_filer.Image'], null=True, blank=True), keep_default=False)

        # Deleting field 'Building.getting_here'
        db.delete_column('contacts_and_people_building', 'getting_here')

        # Deleting field 'Building.access_and_parking'
        db.delete_column('contacts_and_people_building', 'access_and_parking')
