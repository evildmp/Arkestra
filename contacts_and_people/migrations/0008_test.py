...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entity.bogus_field'
        db.add_column('contacts_and_people_entity', 'bogus_field', orm['contacts_and_people.entity:bogus_field'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Entity.bogus_field'
        db.delete_column('contacts_and_people_entity', 'bogus_field')
    ...
    models = {
        ...
        'contacts_and_people.entity': {
            ...
            'bogus_field': ('django.db.models.fields.CharField', [], {'default': "'Vacancies & studentships'", 'max_length': '50'}),
