...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.building'
        db.add_column('contacts_and_people_person', 'building', orm['contacts_and_people.person:building'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Person.building'
        db.delete_column('contacts_and_people_person', 'building_id')
