...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.institutional_username'
        db.add_column('contacts_and_people_person', 'institutional_username', orm['contacts_and_people.person:institutional_username'])
        
        # Changing field 'Person.staff_id'
        # (to signature: django.db.models.fields.CharField(max_length=20, null=True, blank=True))
        db.alter_column('contacts_and_people_person', 'staff_id', orm['contacts_and_people.person:staff_id'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Person.institutional_username'
        db.delete_column('contacts_and_people_person', 'institutional_username')
    ...
    models = {
        ...
        'contacts_and_people.membership': {
            ...
            'membership_order': ('django.db.models.fields.IntegerField', [], {'default': '1', 'null': 'True', 'blank': 'True'}),
