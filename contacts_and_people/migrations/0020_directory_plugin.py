...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EntityDirectoryPluginEditor.display_descriptions_to_level'
        db.add_column('cmsplugin_entitydirectoryplugineditor', 'display_descriptions_to_level', orm['contacts_and_people.entitydirectoryplugineditor:display_descriptions_to_level'])
        
        # Deleting field 'EntityDirectoryPluginEditor.display_description'
        db.delete_column('cmsplugin_entitydirectoryplugineditor', 'display_description')
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'EntityDirectoryPluginEditor.display_descriptions_to_level'
        db.delete_column('cmsplugin_entitydirectoryplugineditor', 'display_descriptions_to_level')
        
        # Adding field 'EntityDirectoryPluginEditor.display_description'
        db.add_column('cmsplugin_entitydirectoryplugineditor', 'display_description', orm['contacts_and_people.entitydirectoryplugineditor:display_description'])
    ...
    models = {
        ...
        'contacts_and_people.entitydirectoryplugineditor': {
            ...
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'display_descriptions_to_level': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
