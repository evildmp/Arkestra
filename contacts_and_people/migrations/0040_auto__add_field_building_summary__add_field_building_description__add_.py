...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('contacts_and_people_building', 'description', self.gf('django.db.models.fields.related.ForeignKey')(related_name='description', null=True, to=orm['cms.Placeholder']), keep_default=False)
        ...
        db.add_column('contacts_and_people_building', 'access_and_parking', self.gf('django.db.models.fields.related.ForeignKey')(related_name='access_and_parking', null=True, to=orm['cms.Placeholder']), keep_default=False)
    ...
    models = {
        ...
        'contacts_and_people.building': {
            ...
            'access_and_parking': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'access_and_parking'", 'null': 'True', 'to': "orm['cms.Placeholder']"}),
            'additional_street_address': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'description'", 'null': 'True', 'to': "orm['cms.Placeholder']"}),
