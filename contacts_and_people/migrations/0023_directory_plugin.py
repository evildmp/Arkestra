...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EntityDirectoryPluginEditor.link_icons'
        db.add_column('cmsplugin_entitydirectoryplugineditor', 'link_icons', orm['contacts_and_people.entitydirectoryplugineditor:link_icons'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'EntityDirectoryPluginEditor.link_icons'
        db.delete_column('cmsplugin_entitydirectoryplugineditor', 'link_icons')
