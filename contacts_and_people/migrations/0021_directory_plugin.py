...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EntityDirectoryPluginEditor.display_descriptions_to_level'
        # (to signature: django.db.models.fields.SmallIntegerField())
        db.alter_column('cmsplugin_entitydirectoryplugineditor', 'display_descriptions_to_level', orm['contacts_and_people.entitydirectoryplugineditor:display_descriptions_to_level'])
    ...
    models = {
        ...
        'contacts_and_people.entitydirectoryplugineditor': {
            ...
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'display_descriptions_to_level': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
