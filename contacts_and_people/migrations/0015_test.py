...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_entityautopagelinkplugineditor', (
            ('cmsplugin_ptr', orm['contacts_and_people.entityautopagelinkplugineditor:cmsplugin_ptr']),
            ('entity', orm['contacts_and_people.entityautopagelinkplugineditor:entity']),
        ))
