...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Building.about'
        db.delete_column('contacts_and_people_building', 'about')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Building.about'
        db.add_column('contacts_and_people_building', 'about', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
