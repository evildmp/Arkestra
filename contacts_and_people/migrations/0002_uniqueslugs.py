...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Creating unique_together for [slug] on Person.
        db.create_unique('contacts_and_people_person', ['slug'])
        
        # Creating unique_together for [slug] on Building.
        db.create_unique('contacts_and_people_building', ['slug'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [slug] on Building.
        db.delete_unique('contacts_and_people_building', ['slug'])
        
        # Deleting unique_together for [slug] on Person.
        db.delete_unique('contacts_and_people_person', ['slug'])
