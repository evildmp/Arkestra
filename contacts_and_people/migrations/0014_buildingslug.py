...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Building.slug'
        # (to signature: django.db.models.fields.SlugField(db_index=True, max_length=255, unique=True, null=True, blank=True))
        db.alter_column('contacts_and_people_building', 'slug', orm['contacts_and_people.building:slug'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Building.slug'
        # (to signature: django.db.models.fields.SlugField(blank=True, unique=True, max_length=50, null=True, db_index=True))
        db.alter_column('contacts_and_people_building', 'slug', orm['contacts_and_people.building:slug'])
