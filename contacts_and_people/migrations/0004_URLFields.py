...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('contacts_and_people_entity', 'url', orm['contacts_and_people.entity:url'])
        
        # Adding field 'Person.url'
        db.add_column('contacts_and_people_person', 'url', orm['contacts_and_people.person:url'])
