...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Site.image'
        db.delete_column('contacts_and_people_site', 'image_id')
        ...
        # Adding field 'Entity.external_url'
        db.add_column('contacts_and_people_entity', 'external_url', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='entity_item', null=True, to=orm['links.ExternalLink']), keep_default=False)

        # Adding unique constraint on 'Title', fields ['abbreviation']
        db.create_unique('contacts_and_people_title', ['abbreviation'])

        # Adding field 'Building.summary'
        db.add_column('contacts_and_people_building', 'summary', self.gf('django.db.models.fields.TextField')(default='', max_length=256), keep_default=False)

        # Adding field 'Building.description'
        db.add_column('contacts_and_people_building', 'description', self.gf('django.db.models.fields.related.ForeignKey')(related_name='building_description', null=True, to=orm['cms.Placeholder']), keep_default=False)

        # Adding field 'Building.getting_here'
        db.add_column('contacts_and_people_building', 'getting_here', self.gf('django.db.models.fields.related.ForeignKey')(related_name='getting_here', null=True, to=orm['cms.Placeholder']), keep_default=False)

        # Adding field 'Building.access_and_parking'
        db.add_column('contacts_and_people_building', 'access_and_parking', self.gf('django.db.models.fields.related.ForeignKey')(related_name='building_access_and_parking', null=True, to=orm['cms.Placeholder']), keep_default=False)

        # Adding field 'Building.map'
        db.add_column('contacts_and_people_building', 'map', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Building.latitude'
        db.add_column('contacts_and_people_building', 'latitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Building.longitude'
        db.add_column('contacts_and_people_building', 'longitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Building.zoom'
        db.add_column('contacts_and_people_building', 'zoom', self.gf('django.db.models.fields.IntegerField')(default=17, null=True, blank=True), keep_default=False)
        ...
        # Adding field 'Person.external_url'
        db.add_column('contacts_and_people_person', 'external_url', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='person_item', null=True, to=orm['links.ExternalLink']), keep_default=False)

        # Adding field 'Person.description'
        db.add_column('contacts_and_people_person', 'description', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True), keep_default=False)

        # Changing field 'Person.precise_location'
        db.alter_column('contacts_and_people_person', 'precise_location', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Removing unique constraint on 'Title', fields ['abbreviation']
        db.delete_unique('contacts_and_people_title', ['abbreviation'])

        # Deleting model 'EntityMembersPluginEditor'
        db.delete_table('cmsplugin_entitymembersplugineditor')

        # Adding field 'Site.image'
        db.add_column('contacts_and_people_site', 'image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['image_filer.Image'], null=True, blank=True), keep_default=False)

        # Adding field 'Entity.auto_publications_page'
        db.add_column('contacts_and_people_entity', 'auto_publications_page', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Entity.publications_page_menu_title'
        db.add_column('contacts_and_people_entity', 'publications_page_menu_title', self.gf('django.db.models.fields.CharField')(default='Publications', max_length=50), keep_default=False)

        # Deleting field 'Entity.external_url'
        db.delete_column('contacts_and_people_entity', 'external_url_id')

        # Deleting field 'Building.summary'
        db.delete_column('contacts_and_people_building', 'summary')

        # Deleting field 'Building.description'
        db.delete_column('contacts_and_people_building', 'description_id')

        # Deleting field 'Building.getting_here'
        db.delete_column('contacts_and_people_building', 'getting_here_id')

        # Deleting field 'Building.access_and_parking'
        db.delete_column('contacts_and_people_building', 'access_and_parking_id')

        # Deleting field 'Building.map'
        db.delete_column('contacts_and_people_building', 'map')
        ...
        # Deleting field 'Building.zoom'
        db.delete_column('contacts_and_people_building', 'zoom')

        # Changing field 'Building.image'
        db.alter_column('contacts_and_people_building', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['image_filer.Image'], null=True))

        # Deleting field 'Person.external_url'
        db.delete_column('contacts_and_people_person', 'external_url_id')

        # Deleting field 'Person.description'
        db.delete_column('contacts_and_people_person', 'description_id')

        # Changing field 'Person.precise_location'
        db.alter_column('contacts_and_people_person', 'precise_location', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
