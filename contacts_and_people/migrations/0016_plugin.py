...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EntityAutoPageLinkPluginEditor.link_to'
        db.add_column('cmsplugin_entityautopagelinkplugineditor', 'link_to', orm['contacts_and_people.entityautopagelinkplugineditor:link_to'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'EntityAutoPageLinkPluginEditor.link_to'
        db.delete_column('cmsplugin_entityautopagelinkplugineditor', 'link_to')
