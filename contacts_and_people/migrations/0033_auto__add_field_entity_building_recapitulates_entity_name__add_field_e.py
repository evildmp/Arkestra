...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entity.building_recapitulates_entity_name'
        db.add_column('contacts_and_people_entity', 'building_recapitulates_entity_name', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # # Adding field 'Entity.auto_publications_page'
        # db.add_column('contacts_and_people_entity', 'auto_publications_page', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
        # 
        ...
        # Changing field 'Entity.slug'
        db.alter_column('contacts_and_people_entity', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=60))

        # Changing field 'Person.slug'
        db.alter_column('contacts_and_people_person', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=60))


    def backwards(self, orm):
        
        # Deleting field 'Entity.building_recapitulates_entity_name'
        db.delete_column('contacts_and_people_entity', 'building_recapitulates_entity_name')
        ...
        # Changing field 'Entity.slug'
        db.alter_column('contacts_and_people_entity', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50))

        # Changing field 'Person.slug'
        db.alter_column('contacts_and_people_person', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50))
