...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('contacts_and_people_person', 'active', orm['contacts_and_people.person:active'])
        
        # Deleting field 'Person.abstract_entity'
        db.delete_column('contacts_and_people_person', 'abstract_entity')
    ...
    def backwards(self, orm):
        ...
        db.delete_column('contacts_and_people_person', 'active')
        
        # Adding field 'Person.abstract_entity'
        db.add_column('contacts_and_people_person', 'abstract_entity', orm['contacts_and_people.person:abstract_entity'])
