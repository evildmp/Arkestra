...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('contacts_and_people_entity', 'external_url', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entity_item', blank=True, null=True, to=orm['links.ExternalLink']), keep_default=False)
        ...
        db.delete_column('contacts_and_people_person', 'about')

        # Adding field 'Person.external_url'
        db.add_column('contacts_and_people_person', 'external_url', self.gf('django.db.models.fields.related.ForeignKey')(related_name='person_item', blank=True, null=True, to=orm['links.ExternalLink']), keep_default=False)

        # Changing field 'Person.precise_location'
        db.alter_column('contacts_and_people_person', 'precise_location', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        db.add_column('contacts_and_people_person', 'about', self.gf('django.db.models.fields.TextField')(max_length=2000, null=True, blank=True), keep_default=False)

        # Deleting field 'Person.external_url'
        db.delete_column('contacts_and_people_person', 'external_url_id')

        # Changing field 'Person.precise_location'
        db.alter_column('contacts_and_people_person', 'precise_location', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True))
    ...
    models = {
        ...
        'contacts_and_people.entityautopagelinkplugineditor': {
            ...
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'auto_page_plugin'", 'blank': 'True', 'null': 'True', 'to': "orm['contacts_and_people.Entity']"}),
        ...
        'contacts_and_people.entitydirectoryplugineditor': {
            ...
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'directory_plugin'", 'blank': 'True', 'null': 'True', 'to': "orm['contacts_and_people.Entity']"}),
            ...
            'use_short_names': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'})
        },
        ...
        'contacts_and_people.entitymembersplugineditor': {
            ...
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'entity_members_plugin'", 'blank': 'True', 'null': 'True', 'to': "orm['contacts_and_people.Entity']"})
        },
        ...
        'contacts_and_people.person': {
            ...
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'entities': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'people'", 'null': 'True', 'blank': 'True', 'through': "'Membership'", 'to': "orm['contacts_and_people.Entity']"}),
