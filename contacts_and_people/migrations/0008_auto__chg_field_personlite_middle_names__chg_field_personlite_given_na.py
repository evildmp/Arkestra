...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PersonLite.middle_names'
        db.alter_column('contacts_and_people_personlite', 'middle_names', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'PersonLite.given_name'
        db.alter_column('contacts_and_people_personlite', 'given_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

    def backwards(self, orm):

        # Changing field 'PersonLite.middle_names'
        db.alter_column('contacts_and_people_personlite', 'middle_names', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'PersonLite.given_name'
        db.alter_column('contacts_and_people_personlite', 'given_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
