...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Entity.auto_vacancies_page'
        db.delete_column('contacts_and_people_entity', 'auto_vacancies_page')

        # Deleting field 'Entity.vacancies_page_menu_title'
        db.delete_column('contacts_and_people_entity', 'vacancies_page_menu_title')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Entity.auto_vacancies_page'
        db.add_column('contacts_and_people_entity', 'auto_vacancies_page', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Entity.vacancies_page_menu_title'
        db.add_column('contacts_and_people_entity', 'vacancies_page_menu_title', self.gf('django.db.models.fields.CharField')(default='Vacancies & studentships', max_length=50), keep_default=False)
