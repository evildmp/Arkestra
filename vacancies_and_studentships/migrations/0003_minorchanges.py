...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('vacancies_and_studentships_vacancy', 'salary', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Vacancy.salary'
        db.alter_column('vacancies_and_studentships_vacancy', 'salary', self.gf('django.db.models.fields.SmallIntegerField')())
    ...
    models = {
        ...
        'vacancies_and_studentships.studentship': {
            ...
            'also_advertise_on': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'studentship_advertise_on'", 'null': 'True', 'to': "orm['contacts_and_people.Entity']"}),
            ...
            'supervisors': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'studentship_people'", 'null': 'True', 'to': "orm['contacts_and_people.Person']"}),
        ...
        'vacancies_and_studentships.vacancy': {
            ...
            'also_advertise_on': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'vacancy_advertise_on'", 'null': 'True', 'to': "orm['contacts_and_people.Entity']"}),
            'closing_date': ('django.db.models.fields.DateField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'hosted_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contacts_and_people.Entity']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
