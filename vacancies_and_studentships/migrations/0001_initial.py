...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('vacancies_and_studentships_vacancy', (
            ('id', orm['vacancies_and_studentships.Vacancy:id']),
            ('short_title', orm['vacancies_and_studentships.Vacancy:short_title']),
            ('title', orm['vacancies_and_studentships.Vacancy:title']),
            ('closing_date', orm['vacancies_and_studentships.Vacancy:closing_date']),
            ('summary', orm['vacancies_and_studentships.Vacancy:summary']),
            ('description', orm['vacancies_and_studentships.Vacancy:description']),
            ('hosted_by', orm['vacancies_and_studentships.Vacancy:hosted_by']),
            ('url', orm['vacancies_and_studentships.Vacancy:url']),
            ('please_contact', orm['vacancies_and_studentships.Vacancy:please_contact']),
            ('slug', orm['vacancies_and_studentships.Vacancy:slug']),
            ('job_number', orm['vacancies_and_studentships.Vacancy:job_number']),
            ('salary', orm['vacancies_and_studentships.Vacancy:salary']),
        ))
        ...
        db.create_table('cmsplugin_vacanciesplugin', (
            ('cmsplugin_ptr', orm['vacancies_and_studentships.VacanciesPlugin:cmsplugin_ptr']),
            ('entity', orm['vacancies_and_studentships.VacanciesPlugin:entity']),
            ('display', orm['vacancies_and_studentships.VacanciesPlugin:display']),
            ('format', orm['vacancies_and_studentships.VacanciesPlugin:format']),
            ('current_items_only', orm['vacancies_and_studentships.VacanciesPlugin:current_items_only']),
            ('limit_to', orm['vacancies_and_studentships.VacanciesPlugin:limit_to']),
            ('heading_level', orm['vacancies_and_studentships.VacanciesPlugin:heading_level']),
            ('vacancies_heading_text', orm['vacancies_and_studentships.VacanciesPlugin:vacancies_heading_text']),
            ('studentships_heading_text', orm['vacancies_and_studentships.VacanciesPlugin:studentships_heading_text']),
            ('more_vacancies_link', orm['vacancies_and_studentships.VacanciesPlugin:more_vacancies_link']),
            ('more_studentships_link', orm['vacancies_and_studentships.VacanciesPlugin:more_studentships_link']),
        ))
        ...
        db.create_table('vacancies_and_studentships_studentship', (
            ('id', orm['vacancies_and_studentships.Studentship:id']),
            ('short_title', orm['vacancies_and_studentships.Studentship:short_title']),
            ('title', orm['vacancies_and_studentships.Studentship:title']),
            ('closing_date', orm['vacancies_and_studentships.Studentship:closing_date']),
            ('summary', orm['vacancies_and_studentships.Studentship:summary']),
            ('description', orm['vacancies_and_studentships.Studentship:description']),
            ('hosted_by', orm['vacancies_and_studentships.Studentship:hosted_by']),
            ('url', orm['vacancies_and_studentships.Studentship:url']),
            ('please_contact', orm['vacancies_and_studentships.Studentship:please_contact']),
            ('slug', orm['vacancies_and_studentships.Studentship:slug']),
        ))
        db.send_create_signal('vacancies_and_studentships', ['Studentship'])
        
        # Adding ManyToManyField 'Studentship.supervisors'
        db.create_table('vacancies_and_studentships_studentship_supervisors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('studentship', models.ForeignKey(orm.Studentship, null=False)),
            ('person', models.ForeignKey(orm['contacts_and_people.Person'], null=False))
        ))
        
        # Adding ManyToManyField 'Vacancy.also_advertise_on'
        db.create_table('vacancies_and_studentships_vacancy_also_advertise_on', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('vacancy', models.ForeignKey(orm.Vacancy, null=False)),
            ('entity', models.ForeignKey(orm['contacts_and_people.Entity'], null=False))
        ))
        
        # Adding ManyToManyField 'Studentship.also_advertise_on'
    ...
    def backwards(self, orm):
        ...
        # Dropping ManyToManyField 'Studentship.supervisors'
        db.delete_table('vacancies_and_studentships_studentship_supervisors')
        
        # Dropping ManyToManyField 'Vacancy.also_advertise_on'
        db.delete_table('vacancies_and_studentships_vacancy_also_advertise_on')
        
        # Dropping ManyToManyField 'Studentship.also_advertise_on'
    ...
    models = {
        ...
        'vacancies_and_studentships.entityplugin': {
            'Meta': {'db_table': "'cmsplugin_entityplugin'"},
