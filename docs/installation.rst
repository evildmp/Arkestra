...
- please note that the current version of the Semantic Presentation Editor does not work with Django's jQuery 1.4.2. 
This will be remedied shortly, but in the meantime a simple fix is to locate and replace Django's bundled jQuery.js
with jQuery 1.3.2.
