...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('news_and_events_event', 'url', orm['news_and_events.event:url'])
        
        # Adding field 'NewsArticle.url'
        db.add_column('news_and_events_newsarticle', 'url', orm['news_and_events.newsarticle:url'])
