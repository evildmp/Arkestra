...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_newsandeventsplugin', (
            ('cmsplugin_ptr', orm['news_and_events.newsandeventsplugin:cmsplugin_ptr']),
            ('entity', orm['news_and_events.newsandeventsplugin:entity']),
            ('display', orm['news_and_events.newsandeventsplugin:display']),
            ('format', orm['news_and_events.newsandeventsplugin:format']),
            ('current_items_only', orm['news_and_events.newsandeventsplugin:current_items_only']),
            ('limit_to', orm['news_and_events.newsandeventsplugin:limit_to']),
            ('heading_level', orm['news_and_events.newsandeventsplugin:heading_level']),
            ('news_heading_text', orm['news_and_events.newsandeventsplugin:news_heading_text']),
            ('events_heading_text', orm['news_and_events.newsandeventsplugin:events_heading_text']),
            ('more_news_link', orm['news_and_events.newsandeventsplugin:more_news_link']),
            ('more_events_link', orm['news_and_events.newsandeventsplugin:more_events_link']),
        ))
