...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Rename field 'Event.link_to_series'
        db.rename_column('news_and_events_event', 'link_to_series', 'do_not_link_to_children')

    def backwards(self, orm):
        
        # Rename field 'Event.link_to_series'
        db.rename_column('news_and_events_event', 'do_not_link_to_children', 'link_to_series')
