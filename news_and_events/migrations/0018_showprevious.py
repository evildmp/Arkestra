...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NewsAndEventsPlugin.show_previous_events'
        db.add_column('cmsplugin_newsandeventsplugin', 'show_previous_events', orm['news_and_events.newsandeventsplugin:show_previous_events'])
        
        # Deleting field 'NewsAndEventsPlugin.current_items_only'
        db.delete_column('cmsplugin_newsandeventsplugin', 'current_items_only')
        
        # Changing field 'Event.slug'
        # (to signature: django.db.models.fields.SlugField(unique=True, max_length=60, db_index=True))
        db.alter_column('news_and_events_event', 'slug', orm['news_and_events.event:slug'])
        
        # Changing field 'NewsArticle.slug'
        # (to signature: django.db.models.fields.SlugField(unique=True, max_length=60, db_index=True))
        db.alter_column('news_and_events_newsarticle', 'slug', orm['news_and_events.newsarticle:slug'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'NewsAndEventsPlugin.show_previous_events'
        db.delete_column('cmsplugin_newsandeventsplugin', 'show_previous_events')
        
        # Adding field 'NewsAndEventsPlugin.current_items_only'
        db.add_column('cmsplugin_newsandeventsplugin', 'current_items_only', orm['news_and_events.newsandeventsplugin:current_items_only'])
