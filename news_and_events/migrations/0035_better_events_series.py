...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Event.do_not_advertise_children'
        db.delete_column('news_and_events_event', 'do_not_advertise_children')

        # Renaming field 'Event.no_direct_access_to_children'
        db.rename_column('news_and_events_event', 'no_direct_access_to_children', 'link_to_series')

        # Deleting field 'Event.inherit_name'
        db.delete_column('news_and_events_event', 'inherit_name')

        # Deleting field 'Event.always_display_series'
        db.delete_column('news_and_events_event', 'always_display_series')

        # Adding field 'Event.display_series_name'
        db.add_column('news_and_events_event', 'display_series_name', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Event.display_series_summary'
        db.add_column('news_and_events_event', 'display_series_summary', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Event.do_not_advertise_children'
        db.add_column('news_and_events_event', 'do_not_advertise_children', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


        # Adding field 'Event.inherit_name'
        db.add_column('news_and_events_event', 'inherit_name', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Event.always_display_series'
        db.add_column('news_and_events_event', 'always_display_series', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Renaming field 'Event.link_to_series'
        db.rename_column('news_and_events_event', 'link_to_series', 'no_direct_access_to_children')

        # Deleting field 'Event.display_series_name'
        db.delete_column('news_and_events_event', 'display_series_name')

        # Deleting field 'Event.display_series_summary'
        db.delete_column('news_and_events_event', 'display_series_summary')
    ...
    models = {
        ...
        'news_and_events.event': {
            ...
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'link_to_series': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
