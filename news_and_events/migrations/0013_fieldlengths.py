...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # (to signature: django.db.models.fields.CharField(max_length=70, null=True, blank=True))
        db.alter_column('news_and_events_event', 'short_title', orm['news_and_events.event:short_title'])
        
        # Changing field 'NewsArticle.short_title'
        # (to signature: django.db.models.fields.CharField(max_length=70, null=True, blank=True))
        db.alter_column('news_and_events_newsarticle', 'short_title', orm['news_and_events.newsarticle:short_title'])
