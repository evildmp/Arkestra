...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('news_and_events_newssource', (
            ('id', orm['news_and_events.newssource:id']),
            ('external_news_source', orm['news_and_events.newssource:external_news_source']),
        ))
        ...
        # Adding field 'NewsArticle.external_news_source'
        db.add_column('news_and_events_newsarticle', 'external_news_source', orm['news_and_events.newsarticle:external_news_source'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'NewsArticle.external_news_source'
        db.delete_column('news_and_events_newsarticle', 'external_news_source_id')
