...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.no_direct_access_to_children'
        db.add_column('news_and_events_event', 'no_direct_access_to_children', orm['news_and_events.event:no_direct_access_to_children'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Event.no_direct_access_to_children'
        db.delete_column('news_and_events_event', 'no_direct_access_to_children')
