...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.child_list_heading'
        db.alter_column('news_and_events_event', 'child_list_heading', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

    def backwards(self, orm):

        # Changing field 'Event.child_list_heading'
        db.alter_column('news_and_events_event', 'child_list_heading', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        'news_and_events.event': {
            ...
            'building': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contacts_and_people.Building']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'child_list_heading': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            ...
            'hosted_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'event_hosted_events'", 'on_delete': 'models.SET_DEFAULT', 'default': '1', 'to': "orm['contacts_and_people.Entity']", 'blank': 'True', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.Image']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
        ...
        'news_and_events.newsarticle': {
            ...
            'hosted_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'newsarticle_hosted_events'", 'on_delete': 'models.SET_DEFAULT', 'default': '1', 'to': "orm['contacts_and_people.Entity']", 'blank': 'True', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.Image']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'importance': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True'}),
            'in_lists': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'db_index': 'True'}),
