...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Creating unique_together for [slug] on Event.
        db.create_unique('news_and_events_event', ['slug'])
        
        # Creating unique_together for [slug] on NewsArticle.
        db.create_unique('news_and_events_newsarticle', ['slug'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [slug] on NewsArticle.
        db.delete_unique('news_and_events_newsarticle', ['slug'])
        
        # Deleting unique_together for [slug] on Event.
        db.delete_unique('news_and_events_event', ['slug'])
