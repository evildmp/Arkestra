...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.alter_column('news_and_events_event', 'url', orm['news_and_events.event:url'])
        
        # Changing field 'NewsArticle.url'
        # (to signature: django.db.models.fields.URLField(max_length=200, null=True, blank=True))
        db.alter_column('news_and_events_newsarticle', 'url', orm['news_and_events.newsarticle:url'])
