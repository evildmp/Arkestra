...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('news_and_events_event', 'image', orm['news_and_events.event:image'])
        
        # Adding field 'NewsArticle.image'
        db.add_column('news_and_events_newsarticle', 'image', orm['news_and_events.newsarticle:image'])
        
        # Changing field 'Event.subtitle'
        # (to signature: django.db.models.fields.TextField(max_length=350, null=True))
        db.alter_column('news_and_events_event', 'subtitle', orm['news_and_events.event:subtitle'])
        
        # Changing field 'NewsArticle.subtitle'
        # (to signature: django.db.models.fields.TextField(max_length=350, null=True))
        db.alter_column('news_and_events_newsarticle', 'subtitle', orm['news_and_events.newsarticle:subtitle'])
    ...
    def backwards(self, orm):
        ...
        db.delete_column('news_and_events_event', 'image_id')
        
        # Deleting field 'NewsArticle.image'
        db.delete_column('news_and_events_newsarticle', 'image_id')
        
        # Changing field 'Event.subtitle'
        # (to signature: django.db.models.fields.TextField(max_length=350, null=True, blank=True))
        db.alter_column('news_and_events_event', 'subtitle', orm['news_and_events.event:subtitle'])
