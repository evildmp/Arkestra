...
class Migration:
    ...
    def backwards(self, orm):
        ...
        db.add_column('news_and_events_newsarticle', 'summary', orm['news_and_events.newsarticle:summary'])
        
        # Adding field 'Event.summary'
        db.add_column('news_and_events_event', 'summary', orm['news_and_events.event:summary'])
