...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NewsAndEventsPlugin.layout'
        db.add_column('cmsplugin_newsandeventsplugin', 'layout', orm['news_and_events.newsandeventsplugin:layout'])
        
        # Deleting field 'NewsAndEventsPlugin.more_events_link'
        db.delete_column('cmsplugin_newsandeventsplugin', 'more_events_link_id')
        
        # Deleting field 'NewsAndEventsPlugin.more_news_link'
        db.delete_column('cmsplugin_newsandeventsplugin', 'more_news_link_id')
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'NewsAndEventsPlugin.layout'
        db.delete_column('cmsplugin_newsandeventsplugin', 'layout')
        
        # Adding field 'NewsAndEventsPlugin.more_events_link'
        db.add_column('cmsplugin_newsandeventsplugin', 'more_events_link', orm['news_and_events.newsandeventsplugin:more_events_link'])
        
        # Adding field 'NewsAndEventsPlugin.more_news_link'
        db.add_column('cmsplugin_newsandeventsplugin', 'more_news_link', orm['news_and_events.newsandeventsplugin:more_news_link'])
