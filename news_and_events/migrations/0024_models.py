...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # (to signature: django.db.models.fields.related.ForeignKey(blank=True, null=True, to=orm['contacts_and_people.Entity']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.hosted_by'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['contacts_and_people.Entity'], blank=True))
        db.alter_column('news_and_events_event', 'hosted_by_id', orm['news_and_events.event:hosted_by'])
