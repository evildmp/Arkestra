...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.testcontent'
        db.add_column('news_and_events_event', 'testcontent', orm['news_and_events.event:testcontent'])
        
        # Adding field 'NewsArticle.testcontent'
        db.add_column('news_and_events_newsarticle', 'testcontent', orm['news_and_events.newsarticle:testcontent'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Event.testcontent'
        db.delete_column('news_and_events_event', 'testcontent')
        
        # Deleting field 'NewsArticle.testcontent'
        db.delete_column('news_and_events_newsarticle', 'testcontent')
    ...
    models = {
        ...
        'news_and_events.event': {
            ...
            'testcontent': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
