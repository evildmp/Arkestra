...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # (to signature: django.db.models.fields.related.ForeignKey(blank=True, to=orm['contacts_and_people.Entity']))
        db.alter_column('news_and_events_event', 'hosted_by_id', orm['news_and_events.event:hosted_by'])
        
        # Changing field 'NewsArticle.hosted_by'
        # (to signature: django.db.models.fields.related.ForeignKey(blank=True, to=orm['contacts_and_people.Entity']))
        db.alter_column('news_and_events_newsarticle', 'hosted_by_id', orm['news_and_events.newsarticle:hosted_by'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.hosted_by'
        # (to signature: django.db.models.fields.related.ForeignKey(null=True, to=orm['contacts_and_people.Entity'], blank=True))
        db.alter_column('news_and_events_event', 'hosted_by_id', orm['news_and_events.event:hosted_by'])
    ...
    models = {
        ...
        'news_and_events.event': {
            ...
            'hosted_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'event_hosted_events'", 'blank': 'True', 'to': "orm['contacts_and_people.Entity']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'news_and_events.newsarticle': {
            ...
            'hosted_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'newsarticle_hosted_events'", 'blank': 'True', 'to': "orm['contacts_and_people.Entity']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'publish_to': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['contacts_and_people.Entity']", 'null': 'True', 'blank': 'True'}),
            'short_title': ('django.db.models.fields.CharField', [], {'max_length': '70', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '60', 'db_index': 'True'}),
