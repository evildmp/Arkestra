...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('news_and_events_event_enquiries', 'news_and_events_event_please_contact')
        db.rename_table('news_and_events_newsarticle_enquiries', 'news_and_events_newsarticle_please_contact')
        
        # Adding field 'NewsAndEventsPlugin.list_format'
        db.add_column('cmsplugin_newsandeventsplugin', 'list_format', self.gf('django.db.models.fields.CharField')(default='vertical', max_length=25), keep_default=False)

        # Adding field 'NewsAndEventsPlugin.group_dates'
        db.add_column('cmsplugin_newsandeventsplugin', 'group_dates', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'NewsAndEventsPlugin.list_format'
        db.delete_column('cmsplugin_newsandeventsplugin', 'list_format')

        # Deleting field 'NewsAndEventsPlugin.group_dates'
        db.delete_column('cmsplugin_newsandeventsplugin', 'group_dates')
        ...
        # Adding M2M table for field enquiries on 'Event'
        db.create_table('news_and_events_event_enquiries', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['news_and_events.event'], null=False)),
            ('person', models.ForeignKey(orm['contacts_and_people.person'], null=False))
        ))
        db.create_unique('news_and_events_event_enquiries', ['event_id', 'person_id'])
        ...
        # Adding M2M table for field enquiries on 'NewsArticle'
        ...
        db.create_unique('news_and_events_newsarticle_enquiries', ['newsarticle_id', 'person_id'])
