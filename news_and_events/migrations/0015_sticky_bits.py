...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('news_and_events_event', 'always_display_series', orm['news_and_events.event:always_display_series'])
        
        # Adding field 'NewsArticle.display_indefinitely'
        db.add_column('news_and_events_newsarticle', 'display_indefinitely', orm['news_and_events.newsarticle:display_indefinitely'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'NewsArticle.display_indefinitely'
        db.delete_column('news_and_events_newsarticle', 'display_indefinitely')
