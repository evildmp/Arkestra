...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('news_and_events_event', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=60, unique=True, blank=True))

        # Changing field 'NewsArticle.slug'
        db.alter_column('news_and_events_newsarticle', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=60, unique=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Event.slug'
        db.alter_column('news_and_events_event', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=60, unique=True))

        # Changing field 'NewsArticle.slug'
        db.alter_column('news_and_events_newsarticle', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=60, unique=True))
    ...
    models = {
        ...
        'news_and_events.event': {
            ...
            'enquiries': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'event_person'", 'blank': 'True', 'null': 'True', 'to': "orm['contacts_and_people.Person']"}),
            ...
            'organisers': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'event_organiser'", 'blank': 'True', 'null': 'True', 'to': "orm['contacts_and_people.Person']"}),
            ...
            'precise_location': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'publishing_destinations': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['contacts_and_people.Entity']", 'null': 'True', 'blank': 'True'}),
            'registration_enquiries': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'event_registration'", 'blank': 'True', 'null': 'True', 'to': "orm['contacts_and_people.Person']"}),
            'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            ...
            'speakers': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'event_speaker'", 'blank': 'True', 'null': 'True', 'to': "orm['contacts_and_people.Person']"}),
        ...
        'news_and_events.newsarticle': {
            ...
            'enquiries': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'newsarticle_person'", 'blank': 'True', 'null': 'True', 'to': "orm['contacts_and_people.Person']"}),
