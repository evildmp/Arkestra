...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('links_externalsite', 'site', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True))

        # Changing field 'ExternalLink.url'
        db.alter_column('links_externallink', 'url', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'ExternalSite.site'
        db.alter_column('links_externalsite', 'site', self.gf('django.db.models.fields.CharField')(max_length=50))
