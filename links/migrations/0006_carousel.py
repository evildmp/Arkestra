...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_carouselplugin', (
            ('cmsplugin_ptr', orm['links.carouselplugin:cmsplugin_ptr']),
            ('name', orm['links.carouselplugin:name']),
            ('width', orm['links.carouselplugin:width']),
            ('aspect_ratio', orm['links.carouselplugin:aspect_ratio']),
        ))
        db.send_create_signal('links', ['CarouselPlugin'])
        
        # Adding model 'CarouselPluginItem'
        db.create_table('links_carouselpluginitem', (
            ('id', orm['links.carouselpluginitem:id']),
            ('destination_content_type', orm['links.carouselpluginitem:destination_content_type']),
            ('destination_object_id', orm['links.carouselpluginitem:destination_object_id']),
            ('plugin', orm['links.carouselpluginitem:plugin']),
            ('image', orm['links.carouselpluginitem:image']),
            ('link_title', orm['links.carouselpluginitem:link_title']),
        ))
    ...
    models = {
        ...
        'links.carouselplugin': {
            'Meta': {'db_table': "'cmsplugin_carouselplugin'"},
