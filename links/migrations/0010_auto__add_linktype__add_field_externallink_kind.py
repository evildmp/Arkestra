...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('links_linktype', (
            ...
            ('scheme', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('links', ['LinkType'])

        # Adding field 'ExternalLink.kind'
        db.add_column('links_externallink', 'kind', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='links', null=True, to=orm['links.LinkType']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ExternalLink.kind'
        db.delete_column('links_externallink', 'kind_id')
