...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExternalSite.domain'
        db.add_column('links_externalsite', 'domain', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'ExternalSite.parent'
        db.add_column('links_externalsite', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['links.ExternalSite']), keep_default=False)

        # Adding field 'ExternalSite.lft'
        db.add_column('links_externalsite', 'lft', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'ExternalSite.rght'
        db.add_column('links_externalsite', 'rght', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'ExternalSite.tree_id'
        db.add_column('links_externalsite', 'tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'ExternalSite.level'
        db.add_column('links_externalsite', 'level', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ExternalSite.domain'
        db.delete_column('links_externalsite', 'domain')

        # Deleting field 'ExternalSite.parent'
        db.delete_column('links_externalsite', 'parent_id')

        # Deleting field 'ExternalSite.lft'
        db.delete_column('links_externalsite', 'lft')

        # Deleting field 'ExternalSite.rght'
        db.delete_column('links_externalsite', 'rght')

        # Deleting field 'ExternalSite.tree_id'
        db.delete_column('links_externalsite', 'tree_id')

        # Deleting field 'ExternalSite.level'
        db.delete_column('links_externalsite', 'level')

        # Changing field 'ExternalLink.url'
        db.alter_column('links_externallink', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True))
