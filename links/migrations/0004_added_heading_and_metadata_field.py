...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ObjectLink.metadata_override'
        db.add_column('links_objectlink', 'metadata_override', orm['links.objectlink:metadata_override'])
        
        # Adding field 'ObjectLink.heading_override'
        db.add_column('links_objectlink', 'heading_override', orm['links.objectlink:heading_override'])
        
        # Adding field 'GenericLinkListPluginItem.metadata_override'
        db.add_column('links_genericlinklistpluginitem', 'metadata_override', orm['links.genericlinklistpluginitem:metadata_override'])
        
        # Adding field 'GenericLinkListPluginItem.heading_override'
        db.add_column('links_genericlinklistpluginitem', 'heading_override', orm['links.genericlinklistpluginitem:heading_override'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'ObjectLink.metadata_override'
        db.delete_column('links_objectlink', 'metadata_override')
        
        # Deleting field 'ObjectLink.heading_override'
        db.delete_column('links_objectlink', 'heading_override')
        
        # Deleting field 'GenericLinkListPluginItem.metadata_override'
        db.delete_column('links_genericlinklistpluginitem', 'metadata_override')
        
        # Deleting field 'GenericLinkListPluginItem.heading_override'
        db.delete_column('links_genericlinklistpluginitem', 'heading_override')
