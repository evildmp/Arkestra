...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GenericLinkListPluginItem.key_link'
        db.add_column('links_genericlinklistpluginitem', 'key_link', orm['links.genericlinklistpluginitem:key_link'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'GenericLinkListPluginItem.key_link'
        db.delete_column('links_genericlinklistpluginitem', 'key_link')
