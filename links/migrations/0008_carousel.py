...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CarouselPlugin.width'
        db.alter_column('cmsplugin_carouselplugin', 'width', self.gf('django.db.models.fields.FloatField')())


    def backwards(self, orm):
        
        # Changing field 'CarouselPlugin.width'
        db.alter_column('cmsplugin_carouselplugin', 'width', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))
