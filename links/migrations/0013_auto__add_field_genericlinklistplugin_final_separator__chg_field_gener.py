...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GenericLinkListPlugin.final_separator'
        db.add_column('cmsplugin_genericlinklistplugin', 'final_separator', self.gf('django.db.models.fields.CharField')(default=' and ', max_length=20, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'GenericLinkListPlugin.final_separator'
        db.delete_column('cmsplugin_genericlinklistplugin', 'final_separator')

        # Changing field 'GenericLinkListPlugin.separator'
        db.alter_column('cmsplugin_genericlinklistplugin', 'separator', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))
