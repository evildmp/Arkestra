...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GenericLinkListPlugin.use_link_icons'
        db.add_column('cmsplugin_genericlinklistplugin', 'use_link_icons', orm['links.genericlinklistplugin:use_link_icons'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'GenericLinkListPlugin.use_link_icons'
        db.delete_column('cmsplugin_genericlinklistplugin', 'use_link_icons')
